...
namespace Projeto_Controle_Vendas.br.com.projeto.dao
{
    public class ProdutoDAO
    {
        ...
        #region Exclusão Lógica de Produto
        public void DesativarProduto(Produto obj)
        {
            try
            {
                //1 Passo - é criar o sql
                string sql = @"update tb_produtos set status_produto = 0 where id = @id";
        ...
        #region Excluir Produto - Exclusão fisica
        ...
        public DataTable listarProdutos()
        {
            try
            {
                ...
                string sql = @"select p.id as 'Código', 
                                      ...
                                      join tb_fornecedores as f on (p.for_id = f.id) where status_produto = 1;";
        ...
        public DataTable listarProdutosPorNome(string nome)
        {
            try
            {
                ...
                string sql = @"select p.id as 'Código', 
                                      ...
                                      p.qtd_estoque as 'Qtd Estoque',
                                      f.nome as 'Fornecedor' from tb_produtos as p
                                      join tb_fornecedores as f on (p.for_id = f.id) where p.descricao like @nome and status_produto = 1;";
        ...
        public DataTable BuscarProdutosPorNome(string nome)
        {
            try
            {
                ...
                string sql = @"select p.id as 'Código', 
                                      ...
                                      p.qtd_estoque as 'Qtd Estoque',
                                      f.nome as 'Fornecedor' from tb_produtos as p
                                      join tb_fornecedores as f on (p.for_id = f.id) where p.descricao = @nome and status_produto = 1;";
        ...
        public Produto retornaProdutoPorCodigo(Int64 id)
        {
            try
            {
                ...
                string sql = @"select * from tb_produtos where id = @id and status_produto = 1";
        ...
        public int retornaEstoqueAtual(int idproduto)
        {
            try
            {
                string sql = @"select qtd_estoque from tb_produtos where id = @id and status_produto = 1";
                int qtd_estoque = 0;
